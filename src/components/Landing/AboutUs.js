    ...
    return (
        <div className='aboutus-container'>
            <MainContent
                ...
                rightBody='We empower organizers to create online events, connect participants to exciting opportunities, and offer a platform for partners to showcase their products. Our mission is to elevate the esports community with a seamless experince.'
